...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        manager.add(new Task("погулять с собакой еще раз",
                "простая, обычная, задача - обновлена", statusNew,30, "10.10.2024-09:00"));
        ...
        manager.add(new Subtask("упаковать коробки",
                "Это подзадача для Эпика 1 - ПЕРЕЕЗД", statusNew, 60,
                "10.01.2025-17:00", 3));
        ...
        manager.add(new Subtask("написать и согласовать ТЗ", 0,
                "Это подзадача для Эпика 2 - ПРОЕКТ", statusNew,1000,
                "15.02.2025-10:00", 4));
